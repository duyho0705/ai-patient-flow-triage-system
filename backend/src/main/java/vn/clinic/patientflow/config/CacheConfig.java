 ...
 * 
 * Cache Tiers:
 * - HOT (short TTL): Real-time dashboards, queue status → 2 min
 * - WARM (medium TTL): AI CDS advice, clinical support → 15 min
 * - COLD (long TTL): Prescription templates, static lookups → 60 min
 * 
