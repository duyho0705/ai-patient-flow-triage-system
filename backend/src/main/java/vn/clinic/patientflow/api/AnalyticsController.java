...
public class AnalyticsController {
    ...
    public Map<String, Object> getTodaySummary(@RequestParam(required = false) UUID branchId) {
        ...
        long completedCount = branchId != null
                ? queueEntryRepository.countByBranchIdAndStatusAndCompletedAtBetween(branchId, "COMPLETED", startOfDay, endOfDay)
                : queueEntryRepository.countByTenantIdAndStatusAndCompletedAtBetween(tenantId, "COMPLETED", startOfDay, endOfDay);
        ...
        long totalAiCalls = branchId != null
                ...
                : aiTriageAuditRepository.countByTriageSessionTenantIdAndCalledAtBetween(tenantId, startOfDay, endOfDay);

        long matchedCount = branchId != null
                ? aiTriageAuditRepository.countByTriageSessionBranchIdAndMatchedTrueAndCalledAtBetween(branchId, startOfDay, endOfDay)
                : aiTriageAuditRepository.countByTriageSessionTenantIdAndMatchedTrueAndCalledAtBetween(tenantId, startOfDay, endOfDay);
    ...
    public Map<String, Object> getWeekSummary(@RequestParam(required = false) UUID branchId) {
        ...
        long completedCount = branchId != null
                ? queueEntryRepository.countByBranchIdAndStatusAndCompletedAtBetween(branchId, "COMPLETED", startOfWeek, endOfWeek)
                : queueEntryRepository.countByTenantIdAndStatusAndCompletedAtBetween(tenantId, "COMPLETED", startOfWeek, endOfWeek);
