...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private final vn.clinic.cdm.service.identity.IdentityService identityService;
        ...
        if (token != null) {
            try {
                ...
                if (claims != null && SecurityContextHolder.getContext().getAuthentication() == null) {
                    ...
                    vn.clinic.cdm.entity.identity.IdentityUser user = identityService.getUserById(userId);
