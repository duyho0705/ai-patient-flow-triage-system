...
import vn.clinic.cdm.dto.clinical.CreateConsultationRequest;
...
public class ClinicalController {
    ...
    private final vn.clinic.cdm.service.clinical.EarlyWarningService earlyWarningService;
    ...
    public ResponseEntity<ApiResponse<vn.clinic.cdm.entity.clinical.Prescription>> createPrescription(
            @RequestBody vn.clinic.cdm.dto.medication.CreatePrescriptionRequest request) {
