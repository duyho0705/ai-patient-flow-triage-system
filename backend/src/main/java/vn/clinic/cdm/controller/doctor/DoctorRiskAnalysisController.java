...
public class DoctorRiskAnalysisController {
    ...
    private final vn.clinic.cdm.repository.clinical.DoctorRepository doctorRepository;
    ...
    public ResponseEntity<ApiResponse<RiskAnalysisDashboardDto>> getRiskAnalysisDashboard() {
        ...
        return ResponseEntity.ok(ApiResponse.success(ReportService.getRiskAnalysisDashboard(doctorUserId)));
    }
    ...
    public ResponseEntity<byte[]> exportRiskReport() {
        ...
        RiskAnalysisDashboardDto dashboard = ReportService.getRiskAnalysisDashboard(doctorUserId);
        ByteArrayInputStream bis = ReportService.generateRiskAnalysisReport(dashboard, doctorName);
